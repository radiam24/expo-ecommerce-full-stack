    ...
    'node_modules/@genezio/nextjs-isr-eu-central-1/node_modules/genezio-remote/dist/lib/remote.node.js'(
        ...
        async function makeRequestNode(request, url, agent) {
            ...
            const options = {
                ...
                path: hostUrl.search
                    ? hostUrl.pathname + hostUrl.search
                    : hostUrl.pathname,
                port: hostUrl.port,
                method: 'POST',
                headers: {
        ...
        var Remote = class {
            ...
            async call(method, ...args) {
                ...
                const response = await makeRequestNode(
                    requestContent,
                    this.url,
                    this.agent
                )
    ...
    'node_modules/@genezio/nextjs-isr-eu-central-1/lib/tagCache.sdk.js'(
        ...
        var TagCache2 =
            ...
            (function () {
                ...
                TagCache3.getLastModified = function (
                    domainName,
                    token2,
                    path,
                    lastModified
                ...
                TagCache3.remote = new genezio_remote_1.Remote(
                    'https://1b5b287d-4f25-47f2-a318-e16149041bda.eu-central-1.cloud.genez.io'
                )
                return TagCache3
            })()
    ...
    'node_modules/@genezio/nextjs-isr-eu-central-1/lib/incrementalCache.sdk.js'(
        ...
        var IncrementalCache2 =
            ...
            (function () {
                ...
                IncrementalCache3.get = function (
                    domainName,
                    token2,
                    key,
                    isFetch
                ...
                IncrementalCache3.set = function (
                    domainName,
                    token2,
                    key,
                    value,
                ...
                IncrementalCache3.remote = new genezio_remote_1.Remote(
                    'https://a9af9ad8-fdfa-4b72-a6b3-3e5814586fda.eu-central-1.cloud.genez.io'
                )
    ...
    'node_modules/@genezio/nextjs-isr-eu-central-1/lib/queue.sdk.js'(exports) {
        ...
        var Queue2 =
            ...
            (function () {
                ...
                Queue3.remote = new genezio_remote_1.Remote(
                    'https://8a22dbb6-5d05-4c10-a6b1-9807b0e1e319.eu-central-1.cloud.genez.io'
                )
                return Queue3
            })()
...
var require_lib = __commonJS({
    'node_modules/@genezio/nextjs-isr-eu-central-1/lib/index.js'(exports) {
        ...
        exports.StorageManager =
            exports.Queue =
            exports.IncrementalCache =
            exports.TagCache =
                void 0
        var tagCache_sdk_1 = require_tagCache_sdk()
        Object.defineProperty(exports, 'TagCache', {
            enumerable: true,
            get: function () {
        ...
        Object.defineProperty(exports, 'IncrementalCache', {
            enumerable: true,
            get: function () {
...
var token =
    (process.env['GENEZIO_CACHE_TOKEN'] || '') +
    '/_cache/' +
    (process.env['NEXT_BUILD_ID'] || '')
var queue = () => ({
    name: 'genezio-queue',
    send: import_nextjs_isr_eu_central_1.Queue.send.bind(
        null,
        deployment,
        token
    ),
...
var incrementalCache = () => ({
    ...
    get: import_nextjs_isr_eu_central_1.IncrementalCache.get.bind(
        null,
        deployment,
        token
    ),
    set: import_nextjs_isr_eu_central_1.IncrementalCache.set.bind(
        null,
        deployment,
        token
    ),
    delete: import_nextjs_isr_eu_central_1.IncrementalCache.delete.bind(
        null,
        deployment,
        token
    ),
...
var tagCache = () => ({
    ...
    getByTag: import_nextjs_isr_eu_central_1.TagCache.getByTag.bind(
        null,
        deployment,
        token
    ),
    getByPath: import_nextjs_isr_eu_central_1.TagCache.getByPath.bind(
        null,
        deployment,
        token
    ),
    getLastModified:
        import_nextjs_isr_eu_central_1.TagCache.getLastModified.bind(
            null,
            deployment,
            token
        ),
    writeTags: import_nextjs_isr_eu_central_1.TagCache.writeTags.bind(
        null,
        deployment,
        token
    ),
