;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [931],
    {
        ...
        5479: function (t, e, a) {
            ...
            let m = 'BUTTON',
                ...
                f = 'web' === x.Z.OS ? (0, c.a)(y, m) : (0, d.W)(y, m),
                w = (0, n.a)({
                    Root: f,
                    Text: g.Z,
                    Group: v.Z,
            ...
            ;(0, p.BO)(f, { className: 'style' }),
                (0, p.BO)(w.Text, { className: 'style' }),
                (0, p.BO)(w.Group, { className: 'style' }),
                (0, p.BO)(w.Spinner, {
                    className: {
                        target: 'style',
            ...
            let j = (0, o.D)({
                ...
                B = s.forwardRef((t, e) => {
                    ...
                    return (0, r.jsx)(w, {
                        ...
                        context: { variant: s, size: n, action: i },
                    })
                }),
                z = s.forwardRef((t, e) => {
                    let {
                        ...
                        { variant: d, size: p, action: l } = (0, c.y)(m)
                    return (0, r.jsx)(w.Text, {
                        ref: e,
                        ...o,
                        className: k({
                            parentVariants: { variant: d, size: p, action: l },
                            variant: s,
                            size: n,
                            action: i,
                            class: a,
                ...
                C = w.Spinner,
                O = s.forwardRef((t, e) => {
                    let { className: a, size: s, ...n } = t,
                        { variant: i, size: o, action: d } = (0, c.y)(m)
                    return 'number' == typeof s
                        ...
                        : (void 0 !== n.height || void 0 !== n.width) &&
                            void 0 === s
                          ? (0, r.jsx)(w.Icon, {
                                ref: e,
                                ...n,
                ...
                S = s.forwardRef((t, e) => {
                    ...
                    return (0, r.jsx)(w.Group, {
                        className: _({ class: a, space: s, isAttached: n }),
                        ...i,
                        ref: e,
                    })
                })
            ;(B.displayName = 'Button'),
                (z.displayName = 'ButtonText'),
    ...
    function (t) {
        t.O(0, [189, 121, 913, 965, 307, 971, 117, 744], function () {
            return t((t.s = 2025))
        }),
            (_N_E = t.O())
    },
