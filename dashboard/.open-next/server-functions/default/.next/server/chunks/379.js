...
${t}`
        ...
        54877: (e, t, r) => {
                ...
                if ((Array.isArray(e.tags) || (e.tags = []), a))
                    for (let r of d(a))
                        (r = `${o.NEXT_CACHE_IMPLICIT_TAG_ID}${r}`),
                            (null == (t = e.tags) ? void 0 : t.includes(r)) ||
                                e.tags.push(r),
                            n.push(r)
                if (i) {
            ...
            function f(e) {
                var t
                if (
                    '__nextPatched' in (t = globalThis.fetch) &&
                    !0 === t.__nextPatched
                )
                    return
                        ...
                        return (0, a.getTracer)().trace(
                                ...
                                : n.AppRenderSpan.fetch,
                            {
                                ...
                                attributes: {
                                    ...
                                    'http.method': h,
                                    'net.peer.name':
                                        null == v ? void 0 : v.hostname,
                                    'net.peer.port':
                                        (null == v ? void 0 : v.port) || void 0,
                                },
                            },
                            async () => {
                                var n
                                ...
                                'string' == typeof x &&
                                    ...
                                    'force-cache' === x
                                        ...
                                        : ('no-cache' === x ||
                                              ...
                                              'only-no-store' === T) &&
                                          (R = 0),
                                    ('no-cache' === x || 'no-store' === x) &&
                                        (C = `cache: ${x}`),
                                    (_ = u(R, v.urlPathname))
                                let A = E('headers'),
                                    I =
                                        'function' ==
                                        typeof (null == A ? void 0 : A.get)
                                            ? A
                                            : new Headers(A || {}),
                                    M =
                                        I.get('authorization') ||
                                ...
                                void 0 === _
                                    ...
                                    (v.forceStatic && 0 === _) ||
                                        ...
                                        (0 === _ &&
                                            (0, s.trackDynamicFetch)(
                                                v,
                                                'revalidate: 0'
                                            ),
                                        (v.revalidate = _))
                                let L =
                                    ('number' == typeof _ && _ > 0) || !1 === _
                                if (v.incrementalCache && L)
                                    try {
                                        a =
                                            await v.incrementalCache.fetchCacheKey(
                                                b,
                                                h ? c : d
                                            )
                                    } catch (e) {
            ...
            class b {
                ...
                trace(...e) {
                    ...
                    let b = this.getSpanContext(
                        ...
                        S = !1
                    b
                        ? (null == (t = s.getSpanContext(b))
                              ? void 0
                              : t.isRemote) && (S = !0)
                        : ((b = (null == o ? void 0 : o.active()) ?? l),
                          (S = !0))
                    let h = v()
                    return (
                        (u.attributes = {
