;(exports.id = 955),
    ...
    (exports.modules = {
        8031: (o, r, c) => {
            Promise.resolve().then(c.bind(c, 43473)),
                Promise.resolve().then(c.bind(c, 26379)),
                Promise.resolve().then(c.bind(c, 27952)),
                Promise.resolve().then(c.bind(c, 76507))
        },
        36839: (o, r, c) => {
            Promise.resolve().then(c.t.bind(c, 63642, 23)),
                Promise.resolve().then(c.t.bind(c, 87586, 23)),
                Promise.resolve().then(c.t.bind(c, 47838, 23)),
                Promise.resolve().then(c.t.bind(c, 58057, 23)),
                Promise.resolve().then(c.t.bind(c, 77741, 23)),
                Promise.resolve().then(c.t.bind(c, 13118, 23))
        },
        43473: (o, r, c) => {
            'use strict'
            c.d(r, { default: () => y })
            ...
            function y({ children: o }) {
                let [r] = (0, e.useState)(() => (0, n.createStyleRegistry)()),
                    c = (0, e.useRef)(!1)
                return (
                    (0, t.useServerInsertedHTML)(() => {
                        i.Z.registerComponent('Main', () => a.Main)
                        let { getStyleElement: o } = i.Z.getApplication('Main')
                        if (!c.current) {
                            c.current = !0
                            let e = [o(), r.styles(), (0, s.y)()]
                            return r.flush(), l.jsx(l.Fragment, { children: e })
                        }
                    }),
                    l.jsx(n.StyleRegistry, { registry: r, children: o })
                )
            }
        },
        26379: (o, r, c) => {
            'use strict'
            c.d(r, { GluestackUIProvider: () => g })
            var l = c(21493),
                e = c(28964),
                t = c.n(e),
                n = c(83281)
...
`
                    ...
                    (0, y.W)(c)
                let e = t().useCallback((o) => {
                    d(o.matches ? 'dark' : 'light')
                }, [])
                return (
                    u(() => {
                        if ('system' !== o) {
                    ...
                    (0, l.jsxs)(l.Fragment, {
                        children: [
                            ...
                            l.jsx(i.N3, {
                                children: l.jsx(s.VW, { children: r.children }),
                            }),
                        ],
                    })
                )
        ...
        73210: (o, r, c) => {
            'use strict'
            c.r(r), c.d(r, { default: () => u, metadata: () => d })
            var l = c(38584),
                e = c(91605),
                t = c.n(e),
                n = c(66326),
            ...
            let s = (0, i.createProxy)(
                String.raw`/Users/vadim/Projects/Youtube/2024/10-11-Ecommerce/part3/FullstackEcommerce/dashboard/app/registry.tsx#default`
            )
            ;(0, i.createProxy)(
                String.raw`/Users/vadim/Projects/Youtube/2024/10-11-Ecommerce/part3/FullstackEcommerce/dashboard/components/ui/gluestack-ui-provider/index.web.tsx#useSafeLayoutEffect`
            )
            let y = (0, i.createProxy)(
                String.raw`/Users/vadim/Projects/Youtube/2024/10-11-Ecommerce/part3/FullstackEcommerce/dashboard/components/ui/gluestack-ui-provider/index.web.tsx#GluestackUIProvider`
            )
            c(67272)
            let d = {
            ...
            function u({ children: o }) {
                return l.tZ('html', {
                    lang: 'en',
                    children: l.tZ('body', {
                        className: `${t().variable} ${a().variable} antialiased bg-background-0`,
                        children: l.tZ(s, {
                            children: l.tZ(y, { mode: 'light', children: o }),
                        }),
                    }),
                })
            }
