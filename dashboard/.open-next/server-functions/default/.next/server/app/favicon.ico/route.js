;(() => {
            ...
            32998: (A, e, t) => {
                ...
                let P = 'force-static',
                    D = new r.AppRouteRouteModule({
                        ...
                        resolvedPagePath:
                            'next-metadata-route-loader?page=%2Ffavicon.ico%2Froute&filePath=%2FUsers%2Fvadim%2FProjects%2FYoutube%2F2024%2F10-11-Ecommerce%2Fpart3%2FFullstackEcommerce%2Fdashboard%2Fapp%2Ffavicon.ico&isDynamic=0!?__next_metadata_route__',
            ...
            67417: (A) => {
                ...
                function n(A) {
                    ...
                    let t = [
                        ...
                        i = `${A.name}=${encodeURIComponent(null != (e = A.value) ? e : '')}`
                    return 0 === t.length ? i : `${i}; ${t.join('; ')}`
                }
                function s(A) {
                    let e = new Map()
                ...
                function a(A) {
                    ...
                    return (function (A) {
                        ...
                        path: u,
                        ...(c && {
                            sameSite: w.includes((e = (e = c).toLowerCase()))
                                ? e
                                : void 0,
                        }),
                        ...(d && { secure: !0 }),
                        ...(h && {
                            priority: P.includes((t = (t = h).toLowerCase()))
                                ? t
                                : void 0,
                        }),
                        ...(g && { partitioned: !0 }),
                ...
                var w = ['strict', 'lax', 'none'],
                    ...
                    D = class {
                        constructor(A) {
                            ...
                            if (e)
                                for (let [A, t] of s(e))
                                    this._parsed.set(A, { name: A, value: t })
                        }
                        [Symbol.iterator]() {
  ...
  `)
            ...
            41217: (A, e, t) => {
                ...
                function a(A, e) {
                    return new URL(
                        String(A).replace(s, 'localhost'),
                        e && String(e).replace(s, 'localhost')
                    )
                }
                ...
                class P {
                    ...
                    analyze() {
                        ...
                        let a = (0, n.getNextPathnameInfo)(
                            ...
                            P = (0, o.getHostname)(
                                this[w].url,
                                this[w].options.headers
                            )
                        this[w].domainLocale = this[w].options.i18nProvider
                            ? this[w].options.i18nProvider.detectDomainLocale(P)
                            : (0, i.detectDomainLocale)(
                                  null == (e = this[w].options.nextConfig)
                                      ? void 0
                                      : null == (A = e.i18n)
                                        ? void 0
                                        : A.domains,
                        ...
                        let D =
                            (null == (t = this[w].domainLocale)
                                ? void 0
                                : t.defaultLocale) ||
                            (null == (s = this[w].options.nextConfig)
                                ? void 0
                                : null == (r = s.i18n)
                                  ? void 0
                                  : r.defaultLocale)
                        ;(this[w].url.pathname = a.pathname),
                            (this[w].defaultLocale = D),
                            (this[w].basePath = a.basePath ?? ''),
                            (this[w].buildId = a.buildId),
                            (this[w].locale = a.locale ?? D),
                            (this[w].trailingSlash = a.trailingSlash)
                    }
                    formatPathname() {
                    ...
                    set password(A) {
                        this[w].url.password = A
                    }
                    get username() {
                        return this[w].url.username
                    }
                    set username(A) {
                        this[w].url.username = A
                    }
                    get basePath() {
                        return this[w].basePath
                    }
                    set basePath(A) {
                        this[w].basePath = A.startsWith('/') ? A : `/${A}`
                    }
                    toString() {
                        return this.href
                    }
                    ...
                    clone() {
                        return new P(String(this), this[w].options)
                    }
                }
            },
            99343: (A, e) => {
                ...
                class t {
                    static get(A, e, t) {
                        let i = Reflect.get(A, e, t)
                        return 'function' == typeof i ? i.bind(A) : i
                    }
                    static set(A, e, t, i) {
                        return Reflect.set(A, e, t, i)
                    }
                    static has(A, e) {
            ...
            87529: (A, e, t) => {
                ...
                class D extends Response {
                    constructor(A, e = {}) {
                        super(A, e)
                        let t = this.headers,
                            w = new Proxy(new s.ResponseCookies(t), {
                                get(A, r, o) {
                                    switch (r) {
                                        case 'delete':
                                        case 'set':
                                        ...
                                        default:
                                            return n.ReflectAdapter.get(A, r, o)
                                    }
                                },
                            })
                        this[a] = {
                            ...
                            url: e.url
                                ? new r.NextURL(e.url, {
                                      headers: (0, o.toNodeOutgoingHttpHeaders)(
                                          t
                                      ),
                                      nextConfig: e.nextConfig,
                                  })
                    ...
                    static redirect(A, e) {
                        ...
                        return (
                            r.set('Location', (0, o.validateURL)(A)),
                            new D(null, { ...i, headers: r, status: t })
                        )
                    }
                    static rewrite(A, e) {
            ...
            49271: (A, e, t) => {
                ...
                function n(A, e) {
                    ...
                    let {
                        ...
                        P = {
                            pathname: A,
                            trailingSlash: '/' !== A ? A.endsWith('/') : w,
                        }
                    s &&
                        (0, o.pathHasPrefix)(P.pathname, s) &&
                        ((P.pathname = (0, r.removePathPrefix)(P.pathname, s)),
                        (P.basePath = s))
                    let D = P.pathname
                    if (
