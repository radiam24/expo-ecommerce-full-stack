;(() => {
        ...
        (e.modules = {
                                                    ...
                                                    children: [
                                                        ...
                                                        {},
                                                        {
                                                            page: [
                                                                ...
                                                                '/Users/vadim/Projects/Youtube/2024/10-11-Ecommerce/part3/FullstackEcommerce/dashboard/app/dashboard/products/[id]/page.tsx',
                                                            ],
                                                        },
                                                    ],
                                                },
            ...
            50172: (e, r, t) => {
                ...
                var a = t(38584),
                    s = t(91735),
                    o = t(79743)
                async function n({ params: { id: e } }) {
                    let r = await (0, s.d)(Number(e))
                    return a.tZ('div', {
                        className: 'max-w-screen-xl mx-auto w-full',
                        children: a.tZ(o.Z, { product: r }),
                    })
                }
            },
            8801: (e, r, t) => {
                ...
                var a = t(38584),
                    ...
                    o = t.n(s),
                    n = t(80476)
                let i = t(61406).$ ? 'flex flex-col relative z-0' : '',
                    l = (0, n.D)({
                        base: i,
                        variants: {
                            size: {
                    ...
                    d = o().forwardRef(
                        (
                            ...
                            a.tZ('div', {
                                className: l({ size: r, variant: t, class: e }),
                                ...s,
                                ref: o,
                            })
                    )
    ...
    r.C(e)
    var t = (e) => r((r.s = e)),
        a = r.X(0, [379, 895, 346, 130, 945, 955, 283], () => t(43857))
    module.exports = a
})()
